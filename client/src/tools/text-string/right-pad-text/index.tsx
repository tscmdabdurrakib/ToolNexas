...
function RightPadText() {
  ...
  useEffect(() => {
    ...
    const padded = inputText.padEnd(targetLength, padding);
    setOutput(padded);
  }, [inputText, targetLength, padChar]);
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast({
        title: "Copied!",
        description: "Right-padded text copied to clipboard",
      });
    } catch (err) {
      toast({
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="text-center space-y-2 pb-4 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20">
          <div className="flex items-center justify-center gap-2">
            ...
            <CardTitle className="text-2xl">Right-pad Text</CardTitle>
          </div>
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <Textarea
              ...
              placeholder="Enter text to right-pad..."
              value={inputText}
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Right-padded text will appear here..."
            />
            <p className="text-xs text-muted-foreground mt-1">
              Output length: {output.length} characters | Padding added: {Math.max(0, output.length - inputText.length)} characters
            </p>
          </div>
