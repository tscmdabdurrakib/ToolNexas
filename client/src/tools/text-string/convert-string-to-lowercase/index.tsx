...
function ConvertStringToLowercase() {
  ...
  useEffect(() => {
    ...
    setOutput(inputText.toLowerCase());
  }, [inputText]);
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast({
        title: "Copied!",
        description: "Lowercase text copied to clipboard",
      });
    } catch (err) {
      toast({
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="text-center space-y-2 pb-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
          <div className="flex items-center justify-center gap-2">
            ...
            <CardTitle className="text-2xl">Convert a String to Lowercase</CardTitle>
          </div>
          <CardDescription>Transform your text to lowercase format instantly</CardDescription>
        </CardHeader>
        <CardContent className="pt-6 space-y-4">
          ...
          <div>
            <Label htmlFor="output">Lowercase Text:</Label>
            <Textarea
              id="output"
