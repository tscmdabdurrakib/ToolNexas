...
function LeftPadText() {
  ...
  useEffect(() => {
    ...
    const padded = inputText.padStart(targetLength, padding);
    setOutput(padded);
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast({
        title: "Copied!",
        description: "Left-padded text copied to clipboard",
      });
    } catch (err) {
      toast({
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="text-center space-y-2 pb-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
          <div className="flex items-center justify-center gap-2">
            ...
            <CardTitle className="text-2xl">Left-pad Text</CardTitle>
          </div>
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <Textarea
              ...
              placeholder="Enter text to left-pad..."
              value={inputText}
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Left-padded text will appear here..."
            />
            <p className="text-xs text-muted-foreground mt-1">
