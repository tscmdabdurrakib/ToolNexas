const e=[{id:1,title:"The Ultimate Guide to Mastering React Hooks",date:"2024-07-28",description:"A deep dive into React Hooks, covering everything from useState to custom hooks. Learn how to write cleaner, more efficient React components.",content:`
...
function Counter() {
  ...
  return (
    ...
    `,category:"React",readingTime:8,author:{name:"Jane Doe",avatar:"https://i.pravatar.cc/150?u=a042581f4e29026704d"},image:"https://images.unsplash.com/photo-1633356122544-f134324a6cee?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",featured:!0},{id:2,title:"TailwindCSS for Modern Web Design",date:"2024-07-25",description:"Discover how TailwindCSS can speed up your development workflow and help you create beautiful, responsive designs without writing custom CSS.",content:`
...
<div class="w-full md:w-1/2 lg:w-1/3">
  {/* ... */}
    ...
    `,category:"CSS",readingTime:5,author:{name:"John Smith",avatar:"https://i.pravatar.cc/150?u=a042581f4e29026705d"},image:"https://images.unsplash.com/photo-1617042375876-a13e36732a04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",featured:!1},{id:3,title:"Getting Started with Vite: The Next-Generation Frontend Tool",date:"2024-07-22",description:"Learn why Vite is becoming the go-to build tool for modern web development, offering lightning-fast hot module replacement and optimized builds.",content:`
    ...
    `,category:"Tooling",readingTime:6,author:{name:"Alex Johnson",avatar:"https://i.pravatar.cc/150?u=a042581f4e29026704d"},image:"https://images.unsplash.com/photo-1617042375876-a13e36732a04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",featured:!1},{id:4,title:"A Guide to SEO for Developers",date:"2024-07-20",description:"SEO is not just for marketers. As a developer, you have a huge impact on your site's search engine ranking. This guide will cover the technical SEO basics you need to know.",content:`
    ...
    `,category:"SEO",readingTime:7,author:{name:"Sarah Lee",avatar:"https://i.pravatar.cc/150?u=a042581f4e29026704d"},image:"https://images.unsplash.com/photo-1617042375876-a13e36732a04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",featured:!1}];export{e as b};
